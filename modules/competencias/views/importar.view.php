        ...
        <form method="POST" enctype="multipart/form-data">
          ...
          <div class="mb-4">
            ...
            <input type="file" name="archivo_competencias" class="form-control" accept=".xlsx, .csv" required
                   data-import-preview data-import-preview-target="#previewCompetencias">
...
<!-- Vista previa del archivo (se pinta aquí, a ancho completo, porque la
     plantilla tiene 5 columnas y no cabe dentro de la tarjeta de carga) -->
<div id="previewCompetencias"></div>
