...
try {
    ...
    if ($aprendiz) {
        ...
        // Obtener detalles de planes de mejoramiento activos (concepto = 'D')
        $stmtD = $db->prepare("
            ...
            LIMIT 3
        ");
        $stmtD->execute([$aprendiz['id']]);
        $alertasD = $stmtD->fetchAll(PDO::FETCH_ASSOC);
    }
} catch (Exception $e) {
    // Silently handle
}
...
<?php if (!empty($alertasD)): ?>
  <div class="card border-0 mb-4" style="border-left: 5px solid var(--danger) !important; border-radius: 12px; background: var(--danger-bg); box-shadow: var(--shadow-sm);">
    <div class="card-body p-3">
      ...
      <div class="row g-2 mb-3">
        <?php foreach ($alertasD as $ad): ?>
          <div class="col-12 col-md-6 col-lg-4">
            <div class="p-2 border rounded shadow-xs" style="font-size: 0.8rem; background: var(--surface); border-color: var(--border) !important;">
      ...
      <a href="<?= APP_URL ?>/modules/mejoramiento/index.php" class="btn btn-sm btn-danger text-white px-3" style="border-radius: 8px; font-size: 0.82rem; font-weight: 600;">
  ...
  <div class="card border-0 mb-4 shadow-sm" style="border-left: 5px solid var(--success) !important; border-radius: 12px; background: var(--success-bg);">
    <div class="card-body p-3 d-flex align-items-center justify-content-between flex-wrap gap-2">
      <div class="d-flex align-items-center">
        <div class="rounded-circle d-flex align-items-center justify-content-center me-3" style="width: 38px; height: 38px; background-color: var(--sena-primary-50); color: var(--success); border: 1.5px solid var(--sena-primary-50);">
...
<div class="row g-3 mb-4">
  ...
  <div class="col-lg-7 col-xl-8">
    <div class="card h-100" style="border-top: 4px solid var(--sena-primary); border-radius: 12px; box-shadow: var(--shadow-sm);">
  ...
  <div class="col-lg-5 col-xl-4">
    <div class="card h-100 hover-scale-sm" style="border-top: 4px solid <?= $rangoColor ?>; border-radius: 12px; box-shadow: var(--shadow-sm); transition: transform 0.25s ease-out;">
      <div class="card-body p-4 d-flex flex-column justify-content-between">
        <div>
        ...
        <div class="pt-2 mt-3 border-top" style="border-color: var(--border) !important;">
          ...
          <?php else: ?>
            <div class="text-success small fw-bold d-flex align-items-center gap-1.5" style="font-size: 0.75rem;">
...
<div class="row g-3">
  ...
  <div class="col-lg-4">
    <div class="card h-100" style="border-radius: 10px;">
      ...
      <div class="card-body" id="dashboard-events-list" style="max-height: 350px; overflow-y: auto;">
